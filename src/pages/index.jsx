...
import profilePic from '../../public/images/profile/indeximg.png';
	...
	return (
		<>
			<Head>
				...
				<meta
					name='description'
					content='Lucas Ribeiro Portfolio | Generated by create next app'
				/>
			</Head>
			<TransitionEffect />
					...
					<div className='flex items-center justify-between w-full lg:flex-col'>
						<div className='w-1/2 md:w-full '>
							<Image
								src={profilePic}
								alt='profile Image'
								className='w-full h-auto lg:hidden  md:w-full md:!inline-block '
								priority
						...
						<div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
							...
							<div className='flex items-center self-start mt-2 lg:self-center'>
								<Link
									href='/Lucas Ribeiro da silva IT.pdf'
									target={'_blank'}
