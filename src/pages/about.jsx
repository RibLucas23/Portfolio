...
import profilePic from '../../public/images/profile/cvImg.png';
...
const about = () => {
	return (
		<>
			<Head>
				<title>Lucas Ribeiro | About</title>
				<meta
					name='description'
					content='Lucas Ribeiro Portfolio | About'
				/>
			</Head>
			<TransitionEffect />
...
'>
				<Layout classname='pt-16'>
					<AnimatedText text='Dedication Drives Our Mission!' classname='mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8' />
